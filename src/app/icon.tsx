...
export default function Icon() {
  return new ImageResponse(
    (
      ...
      >
        <svg width="46" height="46" viewBox="18.25 18.25 457.25 458.25">
          <path
          ...
          />
          <path
            d="M 427.75,203.25 L 292.25,336.00 L 292.25,338.75 L 336.75,381.50 L 469.50,247.75 L 469.50,245.00 Z"
            fill="#4A0E17"
          />
        </svg>
      </div>
