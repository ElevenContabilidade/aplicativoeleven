...
import { ensureClienteFolder, uploadFileToDrive, GoogleDriveNaoConectadoError } from "@/lib/google-drive";
...
export async function POST(request: Request) {
  ...
  try {
    const folderId = await ensureClienteFolder(clienteId, clienteNome);
