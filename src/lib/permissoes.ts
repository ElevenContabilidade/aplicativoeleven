...
export const MODULOS_GESTAO = [
  "Senhas", "Financeiro", "Boletos", "NFSe", "Rentabilidade", "Produtividade", "Parceiros", "Portfólio", "Atendimento", "Relatórios", "Equipe", "Auditoria", "Gestão do CRC", "Scripts", "Eleven IA", "Configurações",
];
